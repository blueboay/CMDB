...
def search_network_device(request):
    ...
    if "other" in request.GET:
        ...
        search_obj.add(Q(Name__icontains=get_data["other"])
                       ...
                       | Q(Position__contains=get_data["other"])
                       | Q(ManageUser__contains=get_data["other"])
                       | Q(WebManageUser__contains=get_data["other"])
                       | Q(WebManageIP__contains=get_data["other"])
                       | Q(ConsoleUser__contains=get_data["other"])
                       | Q(Note__contains=get_data["other"]), Q.OR)
